...
import gr.aueb.sweng22.team09.data.LoginRepository;
import gr.aueb.sweng22.team09.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    private boolean isPasswordValid(String password) {
        return password != null && password.trim().length() <= User.MAX_PASSWORD_LENGTH &&
                password.trim().length() >= User.MIN_PASSWORD_LENGTH;
    }
}